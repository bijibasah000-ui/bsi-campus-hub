...
(function () {
    ...
    function appendMsg(text, type) {
        ...
        div.innerHTML =
            '<div class="msg-av" style="' + avStyle + ' width:30px;height:30px;border-radius:50%;'
    ...
    function send() {
        ...
        .then(function (data) {
            ...
            var reply = data.reply || 'Maaf, aku tidak bisa memproses pesanmu. Coba lagi ya 😊';
            appendMsg(reply, 'bot');
        ...
        .catch(function (err) {
            showTyping(false);
            setLoading(false);
            appendMsg('Maaf, koneksi bermasalah. Pastikan kamu terhubung ke internet dan coba lagi. 🙏', 'bot');
